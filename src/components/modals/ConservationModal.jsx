  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
      ...
      <motion.article
        ...
        className="pointer-events-auto relative z-10 flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden border border-rose-400/35 bg-slate-950/95 shadow-[0_0_50px_rgba(244,63,94,0.2)] backdrop-blur-md"
      >
        {imageSrc ? (
        ...
        <div className="flex items-start justify-between gap-3 border-b border-rose-400/25 px-5 py-4">
          <h2 id="conservation-title" className="font-display text-lg font-semibold uppercase tracking-widest text-rose-100">
            {title}
          </h2>
          <button
            type="button"
